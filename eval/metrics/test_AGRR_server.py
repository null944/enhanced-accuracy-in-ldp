...
domain_sens_list = [100,200,300,400,500,600,700,800,900,1000]#row number
...
domain_collected = domain_sens_list[1]
...
with open("./eval/results/time_cost_AGRR_server.txt", "a") as f:
    f.write("\n" + "="*50 + "\n") 
    f.write("clock:" + time.strftime("%Y-%m-%d %H:%M:%S") + "\n")
    f.write("A fixed: " + str(domain_collected) + "\n")
    f.write("S: " + str(domain_sens_list) + "\n")
    #f.write("S fixed: " + str(domain_sensitive) + "\n")
    #f.write("A: " + str(domain_collec_list) + "\n")
